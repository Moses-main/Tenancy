...
export const CONTRACT_ADDRESSES = {
  baseSepolia: {
    propertyRegistry: getEnv('VITE_PROPERTY_REGISTRY_BASE_SEPOLIA', '0x6d51cE756C9622A3399CBb7355321d4A326Ec09d'),
    tenToken: getEnv('VITE_TEN_TOKEN_BASE_SEPOLIA', '0x214E4a7f581c3f09F6eAE495C5B32836996a41c6'),
    yieldDistributor: getEnv('VITE_YIELD_DISTRIBUTOR_BASE_SEPOLIA', '0xBd9003d875267E7694B500091590C6eC2ddb5510'),
    priceFeedConsumer: getEnv('VITE_PRICE_FEED_CONSUMER_BASE_SEPOLIA', '0xdcd90ADe757a020B7bA917F0f943a01e3b042091'),
    marketplace: getEnv('VITE_MARKETPLACE_BASE_SEPOLIA', '0x1A7d33B33AeCFc22590ae3150D40C5A0F8e63048'),
  },
  sepolia: {
