...
export const CONTRACT_ADDRESSES = {
  baseSepolia: {
    propertyRegistry: getEnv('VITE_PROPERTY_REGISTRY_BASE_SEPOLIA', '0xEeB7C845f7E57e746F0fa2Ce204294353BD32fE7'),
    tenToken: getEnv('VITE_TEN_TOKEN_BASE_SEPOLIA', '0x6Ea4C83fAE66Ef8DF11c6030dA80fEdbBF3f3E27'),
    yieldDistributor: getEnv('VITE_YIELD_DISTRIBUTOR_BASE_SEPOLIA', '0x10299847Dd891e5b36156454AdF5DAc72b1330B8'),
    priceFeedConsumer: getEnv('VITE_PRICE_FEED_CONSUMER_BASE_SEPOLIA', '0xC7f2Cf4845C6db0e1a1e91ED41Bcd0FcC1b0E141'),
    marketplace: getEnv('VITE_MARKETPLACE_BASE_SEPOLIA', '0x5F2A75A3bAeF7B59357CC8c5E9C9b0e179200f01'),
  },
  sepolia: {
