...
exports.getRiskRecommendations = getRiskRecommendations;
exports.performRiskCheck = performRiskCheck;
exports.simulateRiskScenario = simulateRiskScenario;
...
function assessRiskLevel(metrics) {
    if (metrics.safeguardActive)
        return 'critical';
    if (metrics.defaultRatio > 1500)
        return 'high';
    if (metrics.defaultRatio > 500)
        return 'medium';
    return 'low';
}
function getRiskRecommendations(metrics) {
...
async function performRiskCheck(yieldDistributorAddress, rpcUrl) {
...
async function simulateRiskScenario(scenario) {
