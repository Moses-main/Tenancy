...
exports.analyzePropertyWithAI = analyzePropertyWithAI;
exports.batchAnalyzeProperties = batchAnalyzeProperties;
exports.callGroqLLM = callGroqLLM;
exports.determineDistributionStrategy = determineDistributionStrategy;
exports.getMockAnalysis = getMockAnalysis;
...
async function callGroqLLM(property) {
...
function getMockAnalysis(property) {
...
async function batchAnalyzeProperties(properties) {
...
function determineDistributionStrategy(analyses) {
    const highPriority = [];
